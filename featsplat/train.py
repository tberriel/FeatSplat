...
if __name__ == "__main__":
    ...
    parser.add_argument("--test_iterations", nargs="+", type=int, default=[7_000, 21000, 30_000, 35_000, 42_000])
    parser.add_argument("--test_str", nargs="+", type=str, default=[])
    parser.add_argument("--save_iterations", nargs="+", type=int, default=[7_000, 21000, 30_000, 35_000, 42_000])
